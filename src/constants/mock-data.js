...
// variant.scores: [{ tester, dimId, value, comment, date }]
export const INIT_PLANS = [
  ...
  { id: "p1", name: "PPT 生成优化", type: "skill", status: "active", priority: "high", created: "04-01", desc: "对标主流PPT方案，选择最优路径进行迭代。", result: null, variants: [
    { id: "v1", name: "NotebookLM 方案", uploader: "小东", uploaded: "04-02", desc: "基于Google NotebookLM的文档解析+幻灯片生成流程", link: "https://example.com/plan-v1", scores: [
      { tester: "张三", dimId: "d1", value: 4, comment: "", date: "04-03" },
      { tester: "张三", dimId: "d2", value: 5, comment: "", date: "04-03" },
      { tester: "张三", dimId: "d3", value: 4, comment: "整体不错", date: "04-03" },
      { tester: "李四", dimId: "d1", value: 4, comment: "", date: "04-04" },
      { tester: "李四", dimId: "d2", value: 5, comment: "", date: "04-04" },
      { tester: "李四", dimId: "d3", value: 4, comment: "", date: "04-04" },
    ]},
    { id: "v2", name: "MiniMax 方案", uploader: "笑不语", uploaded: "04-02", desc: "调用MiniMax API直接生成幻灯片，稳定性不足", link: "", scores: [
      { tester: "张三", dimId: "d1", value: 3, comment: "", date: "04-03" },
      { tester: "张三", dimId: "d2", value: 2, comment: "经常超时", date: "04-03" },
      { tester: "张三", dimId: "d3", value: 3, comment: "", date: "04-03" },
    ]},
    { id: "v3", name: "Manus 方案", uploader: "小东", uploaded: "04-03", desc: "Manus Agent多步生成，质量高但速度慢", link: "", scores: [] },
    { id: "v4", name: "Accio 方案", uploader: "笑不语", uploaded: "04-03", desc: "", link: "", scores: [] },
  ]},
  { id: "p2", name: "办公套件整合", type: "skill", status: "active", priority: "medium", created: "04-02", desc: "将Word/Excel/PDF能力整合为统一入口。", result: null, variants: [
    { id: "v5", name: "分离式方案", uploader: "笑不语", uploaded: "04-03", desc: "每种格式独立 Skill，通过路由分发", link: "", scores: [
      { tester: "张三", dimId: "d1", value: 4, comment: "", date: "04-04" },
      { tester: "张三", dimId: "d2", value: 4, comment: "", date: "04-04" },
      { tester: "张三", dimId: "d3", value: 3, comment: "入口分散", date: "04-04" },
    ]},
    { id: "v6", name: "一体化方案", uploader: "小东", uploaded: "04-04", desc: "单个 Skill 内部判断文件类型并处理", link: "", scores: [] },
  ]},
  ...
  { id: "p3", name: "视频剪辑技能", type: "skill", status: "next", priority: "high", created: "04-03", desc: "新增 AI 视频自动剪辑能力。", result: null, variants: [
    { id: "v7", name: "基于Seedance方案", uploader: "笑不语", uploaded: "04-04", desc: "使用Seedance 2.0视频生成+剪辑工作流", link: "", scores: [] },
  ]},
  ...
  { id: "p7", name: "数据分析报告", type: "skill", status: "done", priority: "high", created: "03-15", desc: "数据深度分析与可视化报告生成。", result: "adopted", variants: [
    { id: "v8", name: "ECharts 方案", uploader: "小东", uploaded: "03-18", desc: "基于 ECharts 的交互式图表方案", link: "", scores: [
      { tester: "张三", dimId: "d1", value: 5, comment: "图表丰富", date: "03-20" },
      { tester: "张三", dimId: "d2", value: 4, comment: "", date: "03-20" },
      { tester: "张三", dimId: "d3", value: 5, comment: "", date: "03-20" },
      { tester: "李四", dimId: "d1", value: 4, comment: "", date: "03-21" },
      { tester: "李四", dimId: "d2", value: 5, comment: "", date: "03-21" },
      { tester: "李四", dimId: "d3", value: 4, comment: "", date: "03-21" },
    ]},
    { id: "v9", name: "Recharts 方案", uploader: "笑不语", uploaded: "03-19", desc: "React 生态的轻量图表库", link: "", scores: [
      { tester: "张三", dimId: "d1", value: 3, comment: "", date: "03-20" },
      { tester: "张三", dimId: "d2", value: 4, comment: "", date: "03-20" },
      { tester: "张三", dimId: "d3", value: 4, comment: "", date: "03-20" },
    ]},
  ]},
  { id: "p8", name: "旧版 OCR 升级", type: "skill", status: "done", priority: "medium", created: "03-10", desc: "升级 OCR 引擎至 Tesseract 5，提升中文识别率。", result: "shelved", variants: [
    { id: "v10", name: "Tesseract 5 方案", uploader: "小东", uploaded: "03-12", desc: "开源 OCR 引擎升级", link: "", scores: [
      { tester: "李四", dimId: "d1", value: 3, comment: "中文识别仍有偏差", date: "03-15" },
      { tester: "李四", dimId: "d2", value: 3, comment: "", date: "03-15" },
      { tester: "李四", dimId: "d3", value: 2, comment: "部署复杂", date: "03-15" },
    ]},
  ]},
];
