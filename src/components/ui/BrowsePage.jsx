...
import { BROWSE, FONT_MONO } from "../../constants/theme.js";
    ...
    <div style={{ padding: "0 0 40px" }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
          {icon}
          <span style={{ fontFamily: FONT_MONO, fontSize: 13, color: "#5a4a32", letterSpacing: 0.3 }}>{title}</span>
          <span style={{ fontSize: 14, color: "#a09888" }}>共 {count} 件</span>
        </div>
      </div>
      ...
      <div style={{ marginBottom: 16, position: "relative" }}>
        <input
          ...
          style={{
            ...
            background: BROWSE.searchBg, border: "1px solid rgba(0,0,0,0.06)",
          ...
          onBlur={e => { e.target.style.borderColor = "rgba(0,0,0,0.06)"; e.target.style.boxShadow = "0 1px 3px rgba(0,0,0,0.04)"; }}
        />
        <span style={{
          position: "absolute", left: 12, top: "50%", transform: "translateY(-50%)",
          fontSize: 16, color: "#c0b8a8", pointerEvents: "none",
        }}>🔍</span>
      </div>
      ...
      {filtered.length > 0 ? (
        ...
        <div style={{ textAlign: "center", padding: "40px 20px", fontSize: 16, color: "#b0a898" }}>
