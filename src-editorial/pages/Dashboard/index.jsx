...
import { COLOR, GAP, FONT_SIZE, FONT_SERIF, FONT_MONO, FONT_SANS } from "../../constants/theme.js";

const USE_API = import.meta.env.VITE_USE_API !== 'false';
import Stat from "../../components/ui/Stat.jsx";
import PageHeader from "../../components/ui/PageHeader.jsx";
import PromptCard from "../../components/ui/PromptCard.jsx";
...
export default function Dashboard() {
  ...
  return (
    <>
      ...
      {/* ─── Page Header（Perplexity step-card 模式）─── */}
      <PageHeader
        num="01 · 2026 W16"
        title="技能"
        titleEm="overview"
        desc="DeskHub 上 21 个技能、7 个进行中、14 个稳定运行 — 这是团队本周维护的全部。"
      />
      ...
      {/* 第二排：Perplexity 提示卡 — 显示真实"今日待关注"工单 */}
      <div style={{ display: "flex", gap: GAP.md, marginBottom: GAP.xl }}>
        <PromptCard
          num="07"
          body="「PPT 生成 v2」收齐 4 个方案，2 位测试员完成 6 项打分 — 还差一个 Manus 评测。"
          tag="/work-order"
        />
        <PromptCard
          num="08"
          body={`DeskHub「${(topSkills[0]?.name) || 'PPT 生成'}」本周下载领跑，调用上升 18%。`}
          tag="/skill"
        />
        <PromptCard
          num="09"
          body="MCP「Notion 工具集」三维度均已打分，可以定稿采纳。"
          tag="/finalize"
          building
        />
      </div>
