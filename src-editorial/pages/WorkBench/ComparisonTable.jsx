...
export default function ComparisonTable({ variants, dims }) {
  ...
  return (
    <div style={{ overflowX: "auto", marginBottom: GAP.xl }}>
      <table style={{
        minWidth: "100%", borderCollapse: "collapse",
...
// 每列有最小宽度，避免列被挤到显示不全；列多时外层 overflow-x:auto 接管
const thStyle = { padding: `${GAP.md}px ${GAP.base}px`, borderBottom: `1px solid ${COLOR.borderMd}`, textAlign: "left", fontWeight: 500, minWidth: 140, whiteSpace: "nowrap" };
const tdStyle = { padding: `${GAP.sm}px ${GAP.base}px`, borderBottom: `1px solid ${COLOR.borderLt}`, minWidth: 140 };
